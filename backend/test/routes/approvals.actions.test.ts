    ...
    const prisma = {
      ...
      gitCredential: {
        findMany: vi.fn().mockResolvedValue([
          ...
          { id: "c-admin", projectId: "p1", githubAccessToken: "gh", gitlabAccessToken: "gl", gitAuthMode: "https_pat" },
        ]),
      },
    ...
    const prisma = {
      ...
      run: {
        findUnique: vi.fn().mockResolvedValue({
          id: runId,
          issueId: "i1",
          issue: { id: "i1", projectId: "p1", project: { id: "p1", repoUrl: "https://github.com/o/r" } },
          artifacts: [],
        }),
      },
    } as any;
      ...
      run: {
        findUnique: vi.fn().mockResolvedValue({
          ...
          issue: {
            ...
            externalProvider: "github",
            externalNumber: 7,
            project: { id: "p1", repoUrl: "https://github.com/o/r" },
          },
          artifacts: [],
        }),
      },
      ...
      run: {
        findUnique: vi.fn().mockResolvedValue({
          ...
          issue: {
            ...
            externalProvider: "github",
            externalNumber: 7,
            project: { id: "p1", repoUrl: "https://github.com/o/r", scmAdminCredentialId: "c-admin" },
          },
        }),
        update: vi.fn().mockResolvedValue({}),
      },
