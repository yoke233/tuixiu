...
function pickTemplateKey(opts: { templates: TaskTemplate[]; track: TaskTrack | ""; currentKey: string }): string {
...
function sortTemplatesByPriority(track: TaskTrack, templates: TaskTemplate[]): TaskTemplate[] {
