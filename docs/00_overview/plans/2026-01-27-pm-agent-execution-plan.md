...
> 对齐文档：`docs/05_process/workflow-optimization-bmad-lite.md`（P0/P1/P2 路线图与定义）。

- [x] Context Pack 文档：`docs/05_process/project-context.md`、`docs/05_process/definition-of-done.md`
...
- [x] Gate schema：`docs/_meta/gate_decision.schema.json`（后端提供 Zod schema，供后续 gate step 聚合复用）
