...
- 工作流路线图：`docs/09_WORKFLOW_OPTIMIZATION_BMAD_LITE.md`
- 执行计划：`docs/plans/2026-01-27-pm-agent-execution-plan.md`
- 快速开始：`docs/06_QUICK_START_GUIDE.md`
- 环境搭建：`docs/02_ENVIRONMENT_SETUP.md`
- 测试计划：`docs/07_TESTING_PLAN.md`
